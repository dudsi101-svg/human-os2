...
const EKRANY = [
  ...
  // Cardio 0.73.0: pozycja cardio z seedu w planie klienta A + dialog „skąd te liczby”.
  { n: "klient-plan-cardio-dlaczego", rola: "klient", url: "/plan", czekaj: "h1",
    klik: [{ rola: "button", nazwa: "Dlaczego takie cardio?" }], czekajPo: "[role='dialog'], .dlaczego__panel" },
  ...
  { n: "trener-szablony-bloki", rola: "trener", url: "/trener/szablony", czekaj: "h1",
    klik: [{ rola: "tab", nazwa: "Bloki" }], czekajPo: "h2, .card" },
  { n: "trener-klient-plan-edytor-cardio", rola: "trener", url: "/trener/klient/{klient}?zakladka=plan", czekaj: "[role='tablist']",
    klik: [{ rola: "button", nazwa: "+ Nowy plan" }, { rola: "button", nazwa: "+ Cardio" }], czekajPo: "input[type='range']" },
