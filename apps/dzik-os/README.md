...
Status: **pilotaż na produkcji (0.61.0)** — bieżący stan wdrożenia,
...
| [docs/diet-module/PROGRESS.md](docs/diet-module/PROGRESS.md) | Szablony diet ze skalowaniem: stan, endpointy, decyzje, pytania otwarte (0.60.0, za flagą) |
