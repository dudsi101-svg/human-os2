...
MATRIX: dict[tuple[str, str], Access] = {
    ...
    ("GET", "/api/diet/profiles"): Access.COACH_ONLY,
    ("POST", "/api/diet/profiles"): Access.COACH_ONLY,
    ("PUT", "/api/diet/profiles/{profile_id}"): Access.COACH_ONLY,
    ("GET", "/api/diet/templates/{week_id}"): Access.COACH_ONLY,
    ("GET", "/api/diet/templates/{week_id}/meals"): Access.COACH_ONLY,
    ("POST", "/api/diet/templates/{week_id}/preview"): Access.COACH_ONLY,
    ...
    ("GET", "/api/diet/products"): Access.COACH_ONLY,
    ("POST", "/api/diet/products"): Access.ADMIN_ONLY,
    ("POST", "/api/diet/weeks"): Access.COACH_ONLY,
    ("PUT", "/api/diet/weeks/{week_id}"): Access.COACH_ONLY,
    ("GET", "/api/diet/weeks/{week_id}/full"): Access.COACH_ONLY,
    ("POST", "/api/diet/weeks/{week_id}/days/{day_no}/meals"): Access.COACH_ONLY,
    ("PUT", "/api/diet/meals/{meal_id}"): Access.COACH_ONLY,
    ("DELETE", "/api/diet/meals/{meal_id}"): Access.COACH_ONLY,
    ("POST", "/api/diet/meals/{meal_id}/ingredients"): Access.COACH_ONLY,
    ("PUT", "/api/diet/ingredients/{ingredient_id}"): Access.COACH_ONLY,
    ("DELETE", "/api/diet/ingredients/{ingredient_id}"): Access.COACH_ONLY,
    ("POST", "/api/diet/weeks/{week_id}/sweep"): Access.COACH_ONLY,
    ("POST", "/api/diet/weeks/{week_id}/publish"): Access.COACH_ONLY,
    ("POST", "/api/diet/weeks/{week_id}/unpublish"): Access.COACH_ONLY,
    ("POST", "/api/diet/weeks/import"): Access.COACH_ONLY,
