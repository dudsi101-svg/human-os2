...
class Access(str, Enum):
    ...
    #: Wymaga roli COACH albo ADMIN — biblioteka szablonów diet (własność
    #: trenera/dietetyka, bez danych klientów); klient dostaje odmowę.
    COACH_OR_ADMIN = "COACH_OR_ADMIN"
...
MATRIX: dict[tuple[str, str], Access] = {
    ...
    ("GET", "/api/clients/{client_id}/interview"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/interview/answer"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/interview/approve"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/interview/back"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/interview/coach-approve"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/interview/pause"): Access.CLIENT_SCOPED,
    ("GET", "/api/clients/{client_id}/interview/review"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/interview/start"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/interview/summary"): Access.CLIENT_SCOPED,
    ("PUT", "/api/clients/{client_id}/interview/summary"): Access.CLIENT_SCOPED,
    ...
    ("GET", "/api/clients/{client_id}/profile/hints"): Access.CLIENT_SCOPED,
    ...
    ("PUT", "/api/diet/profiles/{profile_id}"): Access.COACH_OR_ADMIN,
    ("GET", "/api/diet/templates/{week_id}"): Access.COACH_OR_ADMIN,
    ("GET", "/api/diet/templates/{week_id}/meals"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/templates/{week_id}/preview"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/assign"): Access.COACH_ONLY,
    ("GET", "/api/diet/assigned/current"): Access.AUTHENTICATED,
    ("GET", "/api/diet/clients/{client_id}/current"): Access.CLIENT_SCOPED,
    ("GET", "/api/diet/assigned/{diet_id}/swaps"): Access.RESOURCE_SCOPED,
    ("POST", "/api/diet/assigned/{diet_id}/swaps"): Access.RESOURCE_SCOPED,
    ("PATCH", "/api/diet/assigned/{diet_id}"): Access.RESOURCE_SCOPED,
    ("GET", "/api/diet/products"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/products"): Access.ADMIN_ONLY,
    ("POST", "/api/diet/weeks"): Access.COACH_OR_ADMIN,
    ("PUT", "/api/diet/weeks/{week_id}"): Access.COACH_OR_ADMIN,
    ("GET", "/api/diet/weeks/{week_id}/full"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/weeks/{week_id}/days/{day_no}/meals"): Access.COACH_OR_ADMIN,
    ("PUT", "/api/diet/meals/{meal_id}"): Access.COACH_OR_ADMIN,
    ("DELETE", "/api/diet/meals/{meal_id}"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/meals/{meal_id}/ingredients"): Access.COACH_OR_ADMIN,
    ("PUT", "/api/diet/ingredients/{ingredient_id}"): Access.COACH_OR_ADMIN,
    ("DELETE", "/api/diet/ingredients/{ingredient_id}"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/weeks/{week_id}/sweep"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/weeks/{week_id}/publish"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/weeks/{week_id}/unpublish"): Access.COACH_OR_ADMIN,
    ("POST", "/api/diet/weeks/import"): Access.COACH_OR_ADMIN,
    ("GET", "/api/clients/{client_id}/wywiady"): Access.CLIENT_SCOPED,
    ("GET", "/api/clients/{client_id}/wywiady/{typ}/definicja"): Access.CLIENT_SCOPED,
    ("PATCH", "/api/clients/{client_id}/wywiady/{typ}/szkic"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/wywiady/{typ}/przeslij"): Access.CLIENT_SCOPED,
    ("GET", "/api/clients/{client_id}/wywiady/{typ}/historia"): Access.CLIENT_SCOPED,
    ("POST", "/api/clients/{client_id}/wywiady/{typ}/przypomnij"): Access.CLIENT_SCOPED,
    ...
    ("GET", "/api/coach/wywiady/do-przegladu"): Access.COACH_ONLY,
    ("GET", "/api/wywiady/zadania"): Access.COACH_ONLY,
    ("POST", "/api/wywiady/zadania/{task_id}/rozstrzygnij"): Access.RESOURCE_SCOPED,
    ...
    ("POST", "/api/coach/food-products/load-builtin"): Access.COACH_ONLY,
    ("GET", "/api/coach/exercises"): Access.COACH_ONLY,
    ("GET", "/api/coach/exercises/by-name"): Access.COACH_ONLY,
    ...
    ("GET", "/api/coach/wiedza/artykuly"): Access.COACH_ONLY,
    ("GET", "/api/coach/wiedza/artykuly/{article_id}/{revision}"): Access.COACH_ONLY,
    ("POST", "/api/coach/wiedza/artykuly/{article_id}/publikuj"): Access.COACH_ONLY,
    ("POST", "/api/coach/wiedza/artykuly/{article_id}/rewizje"): Access.COACH_ONLY,
    ("POST", "/api/coach/wiedza/artykuly/{article_id}/wycofaj"): Access.COACH_ONLY,
    ...
    ("GET", "/api/coach/kulinaria/profile"): Access.COACH_ONLY,
    ("GET", "/api/coach/kulinaria/receptury"): Access.COACH_ONLY,
    ("GET", "/api/coach/kulinaria/receptury/{recipe_id}"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/receptury/{recipe_id}/publikuj"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/receptury/{recipe_id}/wycofaj"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/pokrycie"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/generuj"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/zapisz"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/zamiana/podglad"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/zamiana/zatwierdz"): Access.COACH_ONLY,
    ("POST", "/api/coach/kulinaria/porownanie"): Access.COACH_ONLY,
    ...
    ("GET", "/api/me/exercises/by-name"): Access.AUTHENTICATED,
    ...
    ("POST", "/api/wiedza/opinie"): Access.AUTHENTICATED,
    ("GET", "/api/wiedza/plany/{plan_kind}/{plan_id}/historia-decyzji"): Access.RESOURCE_SCOPED,
    ("GET", "/api/wiedza/start"): Access.AUTHENTICATED,
    ("POST", "/api/wiedza/szukaj"): Access.AUTHENTICATED,
    ("PUT", "/api/wiedza/ustawienia"): Access.AUTHENTICATED,
    ("POST", "/api/wiedza/wyjasnij"): Access.AUTHENTICATED,
    ("DELETE", "/api/wiedza/zakladki/{article_id}"): Access.AUTHENTICATED,
    ("GET", "/api/wiedza/zakladki"): Access.AUTHENTICATED,
    ("PUT", "/api/wiedza/zakladki/{article_id}"): Access.AUTHENTICATED,
    ...
    ("GET", "/api/nutrition-templates"): Access.COACH_ONLY,
    ("POST", "/api/nutrition-templates"): Access.COACH_ONLY,
    ("GET", "/api/nutrition-templates/catalog"): Access.COACH_ONLY,
    ("POST", "/api/nutrition-templates/catalog/{catalog_id}/import"): Access.COACH_ONLY,
    ("PUT", "/api/nutrition-templates/{template_id}"): Access.RESOURCE_SCOPED,
    ("DELETE", "/api/nutrition-templates/{template_id}"): Access.RESOURCE_SCOPED,
    ("POST", "/api/nutrition-templates/{template_id}/copy-to/{client_id}"): Access.RESOURCE_SCOPED,
    ...
    ("POST", "/api/szkice/plan/{plan_kind}/{plan_id}"): Access.RESOURCE_SCOPED,
    ("GET", "/api/szkice/plan/{plan_kind}/{plan_id}/aktywny"): Access.RESOURCE_SCOPED,
    ("GET", "/api/szkice/{draft_id}"): Access.RESOURCE_SCOPED,
    ("PATCH", "/api/szkice/{draft_id}"): Access.RESOURCE_SCOPED,
    ("DELETE", "/api/szkice/{draft_id}"): Access.RESOURCE_SCOPED,
    ("DELETE", "/api/szkice/{draft_id}/elementy/{element_id}"): Access.RESOURCE_SCOPED,
    ("GET", "/api/szkice/{draft_id}/roznice"): Access.RESOURCE_SCOPED,
    ("POST", "/api/szkice/{draft_id}/publikuj"): Access.RESOURCE_SCOPED,
    ("GET", "/api/plany/{plan_kind}/{plan_id}/zmiany"): Access.RESOURCE_SCOPED,
    ("GET", "/api/zmiany/{changeset_id}"): Access.RESOURCE_SCOPED,
    ("POST", "/api/plans/{plan_id}/archiwizuj"): Access.RESOURCE_SCOPED,
    ("POST", "/api/plans/{plan_id}/odepnij"): Access.RESOURCE_SCOPED,
    ("POST", "/api/plans/{plan_id}/duplikuj"): Access.RESOURCE_SCOPED,
    ("POST", "/api/nutrition/{plan_id}/archiwizuj"): Access.RESOURCE_SCOPED,
    ("POST", "/api/nutrition/{plan_id}/odepnij"): Access.RESOURCE_SCOPED,
    ("POST", "/api/nutrition/{plan_id}/duplikuj"): Access.RESOURCE_SCOPED,
    ("PUT", "/api/schedule/{item_id}"): Access.RESOURCE_SCOPED,
    ("PUT", "/api/clients/{client_id}/goals/{goal_id}"): Access.CLIENT_SCOPED,
