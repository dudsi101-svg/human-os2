...
44 testy silnika + 20 API + E2E (46/46 telefon, 9/9 desktop) + sekcja 4c
...
| `agent/wywiad-kaloryczny` | **0.77.0** | **42** | polecenie właściciela 14.09: wywiad kaloryczny wg specyfikacji 1.0 — silnik (PPM Mifflin + Katch, CPM addytywny, makro, 9 flag), pięć ekranów, migracja 42, widoki klienta i trenera, 64 testy + E2E + a11y; **PR #80 gotowy do przeglądu** | scalenie #79 (bez migracji 41 `test_migracje_przenosnosc` jest czerwony — luka w ciągu; wersja 0.76.0 musi wejść przed 0.77.0) | po #79 |
