...
| 10 | polecenie właściciela 14.09: bloki jak szablony (aeroby jako trzeci rodzaj bloku, przypisanie szablonu + bloków) | **0.76.0** (PR #79, `agent/bloki-jak-szablony`) | **41** |
| 11 | polecenie właściciela 14.09: wyrównanie wywiadu „Zapotrzebowanie kaloryczne” do specyfikacji właściciela 1.0 z 13.09 (pięć ekranów, rozbicie CPM, Katch-McArdle, makro, flagi zdrowotne) | **0.77.0** (PR #80, `agent/wywiad-kaloryczny`) | **42** (41 = bloki, scalane przed) |
