...
**Rezerwacje (KOORDYNACJA §0):** wersja **0.67.0** ⟨potwierdzona⟩; migracja **brak**
...
* Plan z kreatora (`NutritionPlan`) poza zakresem — inny katalog bez grup.
...
| 1 dane | `produkty.csv` (grupy), `subst_maps.json` | `grupy_pokrewne.json`, `dieta/grupy.py`, wpis `package-data` | `test_pakietowanie`, test walidacji pliku (grupy istnieją, symetria, brak duplikatów) | dziesiątki tys. |
