...
| Wywiad kaloryczny — ekran zdrowotny | ciąża/karmienie, choroby metaboliczne (tarczyca, cukrzyca, nerki, wątroba), zaburzenia odżywiania, leki wpływające na masę ciała, brak miesiączki, wolne pole „co trener powinien wiedzieć” | bezpieczny cel kaloryczny: wyłączenie deficytu tam, gdzie jest przeciwwskazany, i ostrzeżenie o konieczności konsultacji lekarskiej — **nigdy diagnoza** | **zgoda** (health_data); wszystkie pytania dobrowolne, każde z odpowiedzią „wolę nie odpowiadać” | klient zawsze; trener wyłącznie przy aktywnej zgodzie zdrowotnej (bez zgody pytanie nie pada, a odpowiedzi i flagi z nich wynikające są wycinane po stronie serwera) | do usunięcia konta; odpowiedzi w niezmiennych wersjach wywiadu, flagi pochodne w `calorie_estimates` |
| Bilans kaloryczny (wynik) | PPM, CPM z rozbiciem, cel kaloryczny, makro, BMI, flagi, `formulas_version` | policzenie zapotrzebowania i punktu startowego diety | umowa (pochodna odpowiedzi klienta — decyzja właściciela z 14.09); dane zdrowotne pozostają w wywiadzie | klient (chyba że wynik ukryty do rozmowy z trenerem); trener przy zgodzie na współpracę | do usunięcia konta; wyniki zamrożone (zmiana wzorów nie zmienia historii) |
